...
const TaskCard = ({task,deleteTask,updateTask}:Props) => {
    ...
    if(editTask){
        return(<div className="p-2 h-[100px] min-h-[100px] items-center flex text-left rounded-xl hover:ring-inset
        hover:ring-rose-500
    ...
    return (
        <div className="p-2 h-[100px] min-h-[100px] items-center flex text-left rounded-xl hover:ring-inset hover:ring-rose-500
